    ...
    <div class="bg-white rounded-md shadow-md p-6">
        <form action="{{ route('admin.add.user') }}" method="post">
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div x-data="{ passwordShow: false }" class="relative mt-2">
                                ...
                                <div @click="passwordShow = !passwordShow"
                                    ...
                                    <svg x-show="passwordShow" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div class="sm:col-span-2">
                            <label for="nik" class="block text-sm font-medium leading-6 text-gray-900">Nomor
                        ...
                        <div class="sm:col-span-1">
                            <label for="tanggalLahir" class="block text-sm font-medium leading-6 text-gray-900">
                                Tanggal Lahir
                            </label>
                            <div class="mt-2">
                                <input type="date" name="tanggalLahir" id="tanggalLahir"
                                    value="{{ old('tanggalLahir') }}" autocomplete="tanggalLahir"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('tanggalLahir')
                                <p class="text-red-500 text-xs">{{ $message }}</p>
                        ...
                        <div class="sm:col-span-1">
                            <label for="jeniskelamin" class="block text-sm font-medium leading-6 text-gray-900">Jenis
                                Kelamin</label>
                            <div class="mt-2">
                                <select id="jeniskelamin" name="jeniskelamin" autocomplete="jeniskelamin"
                        ...
                        <div class="sm:col-span-1">
                            ...
                            @endphp
                            <div class="mt-2">
                                <select id="jabatan" name="jabatan" autocomplete="jabatan"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                    <option value="" selected></option>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button type="submit"
                    class="rounded-md  inline-flex justify-center items-center gap-2  bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-md hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Buat
                    baru
