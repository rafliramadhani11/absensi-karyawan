            ...
            <div class="flex items-center ">
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="#"
                            class="text-gray-900 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium transition duration-200">Team</a>
                        <a href="#"
                            class="text-gray-900 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium transition duration-200">Projects</a>
                        <a href="#"
                            class="text-gray-900 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium transition duration-200">Calendar</a>
                        <a href="#"
                            class="text-gray-900 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium transition duration-200">Reports</a>
                    </div>
                </div>
            </div>
